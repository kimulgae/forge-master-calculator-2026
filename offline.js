...
async function calcOffline() {
    ...
    const payload = {
        ...
        baseCoin: parseCurrency(document.getElementById('off-base-coin').value) || 0,     
        baseHammer: parseCurrency(document.getElementById('off-base-hammer').value) || 0, 
...
async function calcForge() {
    ...
    const payload = {
        ...
        baseSellPrice: parseCurrency(document.getElementById('fg-base-sell').value) || 0,
